 ...
 */
public final class PipelineMgr implements ChannelPipelineFactory
{

    // Those are entirely stateless and thus a single instance is needed.
    private static final ChannelBuffer[] DELIMITERS = Delimiters
            .lineDelimiter(); // '\n'
     ...
     *            The CISSD to use.
     */
    public PipelineMgr(final CISSD cissd)
    {
        this.rpchandler = new RpcHandler(cissd);
    }
    ...
    final class DetectHttpOrRpc extends FrameDecoder
    {
                ...
                throws Exception
        {
            ...
            { // Yes sometimes we can be called
