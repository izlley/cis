 ...
 * <p>
 * This is used for queries to the CISW, where we might group multiple
...
final class SpanGroup implements DataPoints
{
     ...
     *            interval.
     */
    SpanGroup(final CISW cisw, final long start_time, final long end_time,
            ...
            Aggregator.Longs, Aggregator.Doubles
    {
         ...
         * </ul>
         */
        private final long[] timestamps; // 32 bit
                                         // unsigned
                                         // + flag
        ...
        SGIterator()
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                if (rate)
                { // Need two values to compute a rate. Load one more.
                    if (it.hasNext())
                    {
                        moveToNext(i);
                    }
