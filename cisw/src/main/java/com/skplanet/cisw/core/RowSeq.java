...
final class RowSeq implements DataPoints
{
    ...
    /** The {@link CISW} instance we belong to. */
    ...
    void addRow(final KeyValue row)
    {
        ...
        final long base_time = Bytes.getUnsignedInt(key, cisw.metrics.width());
    ...
    long baseTime()
    {
        return Bytes.getUnsignedInt(key, cisw.metrics.width());
    }
