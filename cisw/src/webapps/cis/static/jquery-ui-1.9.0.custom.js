...
$.extend(Datepicker.prototype, {
	...
	_generateHTML: function(inst) {
		...
		var showSlider = this._get(inst, 'showSlider');
		if (drawMonth < 0) {
			drawMonth += 12;
			drawYear--;
		}
		...
		'<dt id="Addchdatepic">Time</dt> <dd id="Addchdatepic">00:00</dd> <dt id="Addchdatepic">Slider</dt> <dd id="Addchdatepic"><div id="datepicSlider"></div></dd></dl></div>' : '';
