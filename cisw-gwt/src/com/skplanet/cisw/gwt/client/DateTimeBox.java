 ...
 * titled "DatePicker DatePickerComponent protected ?" from 2008 shows that back
 * then they were working on an extensible {@link DateBox} and
 * {@link DatePicker} for GWT 2, but as of Sep 2010 this hasn't happened. Their
 * suggestion to copy-paste-hack the code is unacceptable so instead we go
 * through a few hoops to make this work.
 */
final class DateTimeBox extends DateBox
{

    private static final DateTimeFormat HHMM_FORMAT = DateTimeFormat
            .getFormat("HH:mm");

    private static final DefaultFormat DATE_FORMAT = new DefaultFormat(
            DateTimeFormat.getFormat("yyyy/MM/dd-HH:mm:ss"))
    {
        /** Adds support for some human readable dates ("1d ago", "10:30"). */
        @Override
        public Date parse(final DateBox box, final String text,
        ...
        protected void setup()
        {
...

            {
...

                {
                    ...
                    hours_minutes
                            .setWidget(2, 2, newSetMinutesButton(10, "10"));
                    hours_minutes
                            .setWidget(2, 3, newSetMinutesButton(20, "20"));
                    hours_minutes
                            .setWidget(2, 4, newSetMinutesButton(30, "30"));
                    hours_minutes
                            .setWidget(2, 5, newSetMinutesButton(40, "40"));
                    hours_minutes
                            .setWidget(2, 6, newSetMinutesButton(50, "50"));
...

                {
                    ...
                    final EventsHandler handler = new EventsHandler()
                    {
                        ...
                        {
                            final Date d = new Date(Integer.parseInt(ts
                                    .getValue()) * 1000L);
                            box.setValue(d, true);
                        }
                    };
