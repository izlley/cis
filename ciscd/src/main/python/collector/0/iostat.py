...
# particular operation), so let's just let CIS do the rate
# calculation for us.
#
...
# for CIS purposes we want to put them under different metrics (versus
...
def main():
    ...
    while True:
        ...
        for line in f_diskstats:
            ...
            # Sometimes there can be a slash in the device name
            # TODO: Remove the substitution once CIS allows `/' in tags.
